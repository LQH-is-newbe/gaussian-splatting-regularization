...
std::tuple<int, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, float>
	...
	const bool debug)
{
  ...
  torch::Tensor out_e_depths = torch::full({H, W}, 0.0, float_opts);
...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
 RasterizeGaussiansBackwardCUDA(
	...
	const torch::Tensor& dL_dout_e_depths,
	const torch::Tensor& sh,
	const int degree,
	const torch::Tensor& campos,
	...
	const bool debug) 
{
  ...
  {  
	  ...
	  dL_dout_e_depths.contiguous().data<float>(),
